                    ...
                    <div class="form__field form__img">
                        <div class="input__img">
                            <input 
                                ...
                                id="avatar" 
                                value="{{ old('avatar') }}">
                            <label for="avatar" class="account__profile-link">
                                Alterar imagem
                            </label>
                            <img 
                                src="{{ asset('storage/img/profile-avatar/profile-blank.png') }}" 
                    ...
                    <div class="form__field">
                        <div class="form__input-box">
                            <input 
                                ...
                                required>
                            <label for="confirm_password" class="form__label">Confirmar senha</label>
                            <span class="form__line"></span>
