            ...
            <div class="form__area">
                <div class="form__field">
                    <div class="form__input-box">
                        <input type="text" name="video_title" value="{{ $route != 'video.update' ? "" : $video['title'] }}" required>
                ...
                <div class="form__field">
                    <div class="form__input-box">
                        <input type="text" name="video_description" value="{{ $route != 'video.update' ? "" : $video['description'] }}" required>
                ...
                <div class="form__field">
                    <div class="form__input-box">
                        <input type="text" name="video_url" value="{{ $route != 'video.update' ? "" : $video['url'] }}" required>
